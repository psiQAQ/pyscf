...
class VerifyInstalledWheelScriptTests(unittest.TestCase):
    ...
    def test_script_discovers_installed_test_directories(self):
        ...
        self.assertIn("[string[]]$FullExcludedPytestNodeIds", text)
        self.assertIn("function Split-PytestNodeId", text)
        self.assertIn("function Get-PytestNodeGroups", text)
        self.assertIn("function Get-PytestNodeGroupTable", text)
    ...
    def test_script_installs_latest_wheel_and_writes_ci_reports(self):
        ...
        self.assertIn('"--deselect"', text)
        self.assertIn("-DeselectNodeIds $deselectNodeIds", text)
    ...
    def test_script_supports_full_and_check_modes(self):
        ...
        self.assertIn("test_dhf_slow.py::KnownValues::test_kernel", text)
        self.assertIn("test_dhf_slow.py::KnownValues::test_solver", text)
        self.assertIn("test_bz.py::KnownValues::test_mc1step_4o4e", text)
        self.assertIn("test_bz.py::KnownValues::test_mc1step_9o8e", text)
        self.assertIn("test_bz.py::KnownValues::test_mc2step_4o4e", text)
